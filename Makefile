...
SRC		= 	main.c errors.c execution/execution.c path/path.c builtins/cd/cd.c pipe/pipe.c execution/dispach.c pipe/utils_pipe.c builtins/export/export.c builtins/export/utils.c parsing/parsing.c parsing/link_list.c parsing/is.c parsing/tools.c
VPATH	=	$(SRC_DIR)
