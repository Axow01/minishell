...
SRC		= 	main.c errors.c execution/execution.c path/path.c builtins/cd/cd.c pipe/pipe.c execution/dispach.c pipe/utils_pipe.c builtins/export/export.c builtins/export/utils.c parsing/ft_strtok.c parsing/parsing.c pipe/pipe_errors.c
VPATH	=	$(SRC_DIR)
